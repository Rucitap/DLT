...
decoder_lstm_outputs, _, _ = LSTM(latent_dim, return_sequences=True, return_state=True)(dec_emb, initial_state=encoder_states)
...
decoder_lstm_inf, state_h_inf, state_c_inf = decoder_lstm_layer(dec_emb_inf, initial_state=decoder_states_inputs)
